<?php
    /**
    *   /api/element/create.php
    *   description: create element from template
    *
    *   request method: POST
    *   format: json
    *
    ...
    */
    ...
    require_once "../../include/class.Element.php";
    ...
    try {
        ...
        $e->templateId = isset($params["templateId"]) ? $params["templateId"]: "";
        $e->create(); 
        $result["data"] = $e; 
        $result["success"] = true;
        ob_clean();
