<?php
    ...
    */
    ...
    /**
    *   general access denied exception
    */
    class MPMAccessDeniedException extends \Exception {
        public function __construct($message = "", $code = 0, Exception $previous = null) {
            parent::__construct($message, $code, $previous);
        }
    ...
    /**
    *   common template (custom templating) exception
    */
    class MPMCustomTemplatingException extends \Exception {
        public function __construct($message = "", $code = 0, Exception $previous = null) {
            parent::__construct($message, $code, $previous);
        }
