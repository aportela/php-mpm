            ...
            if (! file_exists(SQLITE_DATABASE_PATH)) {
                if (! $errors) {
                    $queries = array(
                        ...
                        " CREATE TABLE [ERROR] ([created] TIMESTAMP DEFAULT CURRENT_TIMESTAMP NULL PRIMARY KEY, [class] VARCHAR(64) NOT NULL, [line] INTEGER NOT NULL, [filename] VARCHAR(512)  NOT NULL, [code] INTEGER NOT NULL, [message] TEXT, [trace] VARCHAR(16384) NOT NULL, [user_id] VARCHAR(36), [user_agent] TEXT, [user_remote_address] VARCHAR(15)) ",
