    ...
    <div class="container">
        ...
        <?php
            ...
            if (! file_exists(SQLITE_DATABASE_PATH)) {
                if (! $errors) {
                    $queries = array(
                        " CREATE TABLE [USER] ([id] VARCHAR(36) UNIQUE NOT NULL PRIMARY KEY, [email] VARCHAR(254) UNIQUE NOT NULL, [password] VARCHAR(255) NOT NULL, [name] VARCHAR(32) NOT NULL, [created] TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, [creator] VARCHAR(36) NOT NULL, [type] BOOLEAN DEFAULT '0' NOT NULL); ",
                        ...
                        " INSERT INTO [USER] (id, email, password, name, created, creator, type) VALUES (\"00000000-0000-0000-0000-000000000000\", \"admin@localhost\", \"" . password_hash("password", PASSWORD_BCRYPT, array("cost" => 12)) . "\", \"administrator\", CURRENT_TIMESTAMP, \"00000000-0000-0000-0000-000000000000\", '1'); ",
