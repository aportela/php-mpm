            ...
            if (! file_exists(SQLITE_DATABASE_PATH)) {
                if (! $errors) {
                    $queries = array(
                        ...
                        " CREATE TABLE [TEMPLATE] ([id] VARCHAR(36) NOT NULL PRIMARY KEY, [name] VARCHAR(32) UNIQUE NOT NULL, [description] VARCHAR(128) NULL, [created] TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, [creator] VARCHAR(36) NOT NULL); ",
                        " CREATE TABLE [TEMPLATE_GROUP] ([template_id] VARCHAR(36) NOT NULL, [group_id] VARCHAR(36) NOT NULL, [allow_create] BOOLEAN DEFAULT '0' NOT NULL, [allow_view] BOOLEAN DEFAULT '0' NOT NULL, [allow_update] BOOLEAN DEFAULT '0' NOT NULL, [allow_delete] BOOLEAN DEFAULT '0' NOT NULL, PRIMARY KEY([template_id], [group_id])); ",                        
